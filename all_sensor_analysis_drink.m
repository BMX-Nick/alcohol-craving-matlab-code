function result = all_sensor_analysis_drink( patient )
...
%add more data back up
data020715=single_sensor_analysis(Preclean020715,patient,'1005 Feb 07 15');
data020515=single_sensor_analysis(Preclean020515,patient,'1005 Feb 05 15');
data121614=single_sensor_analysis(Preclean121614,patient,'1005 Dec 16 14');
%combine with survey


for i=1:4
    drink_feb=[data020615.seperate{i};data020815.seperate{i};data020915.seperate{i};data020515.seperate{i};data020715.seperate{i}];
    drink_apr=[data040215.seperate{i};data040415.seperate{i}];%no0403
    drink_dec=[data121714.seperate{i};data121614.seperate{i}];

%preclean=[preclean_feb;preclean_apr;preclean_dec];
    drink_all=[drink_feb;drink_apr;drink_dec];
    drink=drink_all(drink_all(:,4)==1,:);
    drink=drink(:,2:3);
