function result = drink_mood( patient )
...
ylabel('Mood');
title([patient,' drink time mood comparison']);
...
%subsorted_drink=array2table(sorted_drink);
%subsorted_nodrink=array2table(sorted_nodrink);
...
switch length(no_marked)
    case 0
        ...
        xlabel('Time');
        ylabel('mean of Mood');
        title([patient,' nodrink time plot']); 
    case 1
